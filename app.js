...
function validatePhone(phone) {
  ...
  // Acepta 04XX-XXXXXXX (11 dígitos) o formato internacional +584XX...
  return /^(04|\+?584)\d{9}$/.test(cleanPhone);
}
...
submitBtn.addEventListener('click', async () => {
  ...
  // Reemplazar la sección del fetch dentro de submitBtn.addEventListener en app.js:
try {
  const response = await fetch(APP_SCRIPT_URL, {
    method: 'POST',
    // Usar text/plain evita el bloqueo por políticas CORS en Google Apps Script
    headers: {
